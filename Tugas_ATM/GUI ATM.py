#pinNo == str("2213")) or (pinNo == str("4323")) or (pinNo == str("5982")
from tkinter import*
       ...
       #======================================== Frames========================#
        ...
        def enter_Pin ():
            ...
            if ((pinNo == str("2213")) or (pinNo == str("4323")) or (pinNo == str("5982"))):
                ...
                self.txtReceipt.insert(END,'Withdraw Cash \t\t\t Loan ATM' + "\n\n\n\n")
                self.txtReceipt.insert(END,'Cash With Receipt \t\t\t Loan ATM' + "\n\n\n\n")
        ...
        def request_new_pin():
            enter_Pin()
            self.txtReceipt.delete("1.0",END)
            self.txtReceipt.insert(END , '\t\t Welcon to iBank\n')
            self.txtReceipt.insert(END , '\t\t New Pin Will be send to your home adress\n')
            self.txtReceipt.insert(END,'Withdraw Cash \t\t\t Loan ATM' + "\n\n\n\n")
            self.txtReceipt.insert(END,'Cash With Receipt \t\t\t Loan ATM' + "\n\n\n\n")
            self.txtReceipt.insert(END,'Balance  \t\t\t Request New Pin' + "\n\n\n\n\n")
            self.txtReceipt.insert(END,'Mini Statement \t\t\t Print Statement' + "\n\n\n\n\n")
        ...
        def statement():
            ...
            self.txtReceipt.insert(END,'Rent \t\t\t 12000' + "\n\n")
            self.txtReceipt.insert(END,'Tesco \t\t\t 79.36' + "\n\n\n\n")
            self.txtReceipt.insert(END,'Rent  \t\t\t 1200' + "\n\n\n\n\n")
            self.txtReceipt.insert(END,'Sainsbury \t\t\t 69072' + "\n\n\n\n\n")       
...
#---------------------------------------------------------------------------------------------
        ...
        self.btnCancel=Button(TopFrame1, width = 160, height = 60, command=clear,
        ...
        image=self.img8).grid(row=4, column =2, padx=6, pady=4)
        
        self.img9 = PhotoImage(file = "nine.png")
        self.btn9=Button(TopFrame1, width = 160, height = 60, command=insert9,
        image=self.img9 ).grid(row=4, column =1, padx=6, pady=4)
